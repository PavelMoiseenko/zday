    ...
    <div class="popup" id="popup1">
        ...
        <div class="popup-content clearfix">
            <div class="popup-visual">
                <div class="image">
                    <img src=<?php echo  get_template_directory_uri() . "/assets/images/img2.jpg";?> alt="image-description" width="750" height="600">
                </div>
            </div>
            <div class="popup-desc">
                <div class="heading">
                    <h2>ElasticSearch – больше чем поиск / Jenkins CI</h2>
                    <p>Спикеры: Максим Шаев (Software PHP Developer, Tech Lead), Роман Шопин (Software PHP Developer, Tech Lead)</p>
                </div>
